...
class CarDetector():
    ...
    def getInstance():
        ...
        if CarDetector.__instance__ == None:
            CarDetector()
        return CarDetector.__instance__

    def __init__(self,
                weights='./model/car_detector/car_detector.pt',  # model weights
        ...
        if CarDetector.__instance__ != None:
            raise Exception("Car Detector is a singleton!")
        else:
            CarDetector.__instance__ = self
